...
summary_table <- df %>%
  group_by(Year, Group, Subgroup) %>% #grouped by year, Group (Age, Ethnicity), Subroup(listed the Group of Participant), and Maternal deaths for each Subgroup
  summarise(Maternal_Deaths = sum(Maternal_Deaths, na.rm = TRUE), .groups = "drop")
