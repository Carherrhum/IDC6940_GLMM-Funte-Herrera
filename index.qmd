...
```
  ...
  Without offset, the GLMM model implies that the population with the largest number of deaths (age group 25-39) contributes most to maternal mortality rate. However, the riskiest pregnancies 40 and over women, while still being the smallest population. The plot of the model with offsets  shows clearly the risk to women over 40 giving birth. 
...
Additionally, investigation into healthcare access for expecting mothers specific to the Covid-19 pandemic would give insight into the spike in maternal mortality rate in 2022. Given that mortality rate reaches its peak in February 2022 (months before Dobbs), it would be valuable to determine what effect is due to the pandemic in order to better evaluate the impact of the overturn of Roe v. Wade. 
  ...
  Regardless of these limitations, our results reaffirm a well-established and deeply concerning reality: minority women—particularly American Indian or Alaska Native women, and Black women—face significantly higher maternal mortality risks.
  
  In American Indian or Alaska Native communities, healthcare is often provided through the Indian Health Service (IHS). While this care is free, it is not always well-resourced. Health professionals within IHS are often rotated between reservations, making it difficult for patients to build long-term relationships with providers. This lack of consistency may contribute to mistrust, underreporting of symptoms, and missed clinical cues, further elevating health risks.
  
  Similarly, Black women may struggle with issus in with the healthcare system. They may not be heard by their healthcare professionals and which leads to preventable complications and deaths during and after childbirth.
  
 The higher maternal mortality for women over the age of 40 is to be expected, as geriatric pregnancies (those over age 35) are high risk. However, perhaps age is only one part of the picture. Women in this age range often face many life stressors, such as caring for both children and aging parents, while also experiencing age-related health changes that may further elevate pregnancy risks.
 
It’s important to note that our models cannot fully explain the why behind the disparities in mortality rate between these high risk populations. We are not present in the delivery room, during prenatal appointments, or throughout the postpartum period—moments where critical complications can arise. Moreover, while some datasets track prenatal care and health behaviors, they often do not follow maternal outcomes beyond live birth, limiting our ability to connect prenatal risk to maternal death.
